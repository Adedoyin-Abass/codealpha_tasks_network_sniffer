    ...
    while True:
        ...
        if eth_proto == 8:
            ...
            if proto ==1:
                ...
                (src_port, dest_port, sequence, acknowledgment, flag_urg, flag_ack, flag_psh, flag_rst, flag_fin)
                ...
                src_proto, dest_port, length, dta = udp_segment(data)
...
def ipv4_data_packet(data):
    ...
    ttl, proto, src, dest = struct.unpack('!8x 8 8 zx 4s 4s', data[:20])
...
def icmp_data_packet(data):
    icmp_type, code, checksum = struct.unpack('! 8 8 H', data[:4])
